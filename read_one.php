            ...
            <div class="col">
                <div class="card">
                    <?php
                        if ($note->num_rows > 0) {
                            while ($row = $note->fetch_assoc()) {
                                ...
                                $imagePath = $row["image_path"]; // Retrieve image path
                                ...
                                echo "
                                    ...
                                    <div class='card-body'>
                                        ...
                                        Priority: $priority
                                        <hr>
                                        <img src='$imagePath' alt='Note Image' style='max-width: 100%;'>
                                    </div>
                                ";
                            }
                        }
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn btn-secondary" href="update.php?id=<?php echo $id; ?>">Edit</a>
